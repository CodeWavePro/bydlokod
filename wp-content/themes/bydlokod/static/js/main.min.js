(function (factory) {
  ...
  const login = () => {
    ...
    form.addEventListener('submit', e => {
      ...
      button.appendChild(loader); // Clear form message.
      ...
      bydloAjaxRequest(formData).then(response => {
        if (response) {
          ...
          switch (response.success) {
            ...
            case false:
              console.error(response.data.msg); // TODO: move to another export like forms.js.

              if (msg) msg.innerHTML = response.data.msg; // If has errors.

              if (response.data.errors.length) processFormErrors(JSON.parse(response.data.errors), form);
              break;
          }
        }
